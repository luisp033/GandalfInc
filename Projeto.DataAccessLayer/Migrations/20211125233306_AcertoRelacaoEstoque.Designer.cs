...
namespace Projeto.DataAccessLayer.Migrations
{
    ...
    [Migration("20211125233306_AcertoRelacaoEstoque")]
    partial class AcertoRelacaoEstoque
    {
            ...
            modelBuilder.Entity("Projeto.DataAccessLayer.Entidades.PontoDeVenda", b =>
                {
                    ...
                    b.Property<Guid?>("UtilizadorLogadoIdentificador")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UtilizadorLogadoIdentificador");
            ...
            modelBuilder.Entity("Projeto.DataAccessLayer.Entidades.PontoDeVenda", b =>
                {
                    ...
                    b.HasOne("Projeto.DataAccessLayer.Entidades.Utilizador", "UtilizadorLogado")
                        .WithMany()
                        .HasForeignKey("UtilizadorLogadoIdentificador");

                    b.Navigation("Loja");

                    b.Navigation("UtilizadorLogado");
                });
